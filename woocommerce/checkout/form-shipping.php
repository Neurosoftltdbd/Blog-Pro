<?php
/**
 * Checkout shipping information form — Tailwind styling.
 */
...
<div class="woocommerce-shipping-fields">
	<?php if ( true === WC()->cart->needs_shipping_address() ) : ?>
		...
		<h3 id="ship-to-different-address" class="text-sm font-medium mb-3">
		...
		<div class="shipping_address bg-white rounded-2xl border border-gray-100 shadow-sm p-5 md:p-6">
...
<div class="woocommerce-additional-fields">
	...
	<?php if ( apply_filters( 'woocommerce_enable_order_notes_field', 'yes' === get_option( 'woocommerce_enable_order_comments', 'yes' ) ) ) : ?>
		...
		<div class="woocommerce-additional-fields__field-wrapper bg-white rounded-2xl border border-gray-100 shadow-sm p-5 md:p-6">
