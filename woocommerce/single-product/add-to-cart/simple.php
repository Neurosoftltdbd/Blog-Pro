...
if ( $product->is_in_stock() ) : ?>
	...
	<form id="blogpro-atc-form" class="cart flex items-center gap-3 mt-4" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
