<?php
/**
 * Result Count — Tailwind text.
 *
 * Keeps .woocommerce-result-count + role="status" (screen readers
 * announce the filtered total after a re-render).
 */
if ( ! defined( 'ABSPATH' ) ) exit;
?>
<p class="woocommerce-result-count text-sm text-gray-500 m-0" role="status" aria-relevant="all" <?php echo ( empty( $orderedby ) || 1 === intval( $total ) ) ? '' : 'data-is-sorted-by="true"'; ?>>
	<?php
