<?php
/**
 * Taxonomy template: fallback for custom taxonomies. Category and tag
 * archives fall back here as well unless more specific templates exist.
 */
...
<div class="max-w-7xl mx-auto px-4 pt-9">
	...
	<div class="text-center justify-center items-center py-8">
		<h1 class="text-3xl md:text-5xl font-bold text-gray-900"><?php single_term_title(); ?></h1>
	...
	<div class="text-center py-20">
		...
		<p class="text-gray-600 mb-6"><?php esc_html_e( 'No posts are assigned to this term yet.', 'blog-pro' ); ?></p>
		<?php get_search_form(); ?>
	</div>
	<?php endif; ?>
</div>
