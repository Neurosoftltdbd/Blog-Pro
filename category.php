<?php
/**
 * Category archive template: shows the category name and its posts grid.
 */
...
<div class="max-w-7xl mx-auto px-4 pt-9">
	...
	<div class="text-center justify-center items-center py-8">
		<h1 class="text-3xl md:text-5xl font-bold text-gray-900"><?php single_cat_title(); ?></h1>
	...
	<div class="text-center py-20">
		...
		<p class="text-gray-600 mb-6"><?php esc_html_e( 'No posts are in this category yet.', 'blog-pro' ); ?></p>
		<?php get_search_form(); ?>
	</div>
	<?php endif; ?>
</div>
