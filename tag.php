<?php
/**
 * Tag archive template: shows the tag name and its posts grid.
 */
...
<div class="max-w-7xl mx-auto px-4 pt-9">
	...
	<div class="text-center justify-center items-center py-8">
		<h1 class="text-3xl md:text-5xl font-bold text-gray-900">
			<?php printf( esc_html__( 'Tag: %s', 'blog-pro' ), '<span class="text-indigo-600">' . single_term_title( '', false ) . '</span>' ); ?>
		</h1>
		<?php if ( get_the_archive_description() ) : ?>
			<div class="max-w-2xl mx-auto mt-4 text-gray-800 leading-relaxed"><?php echo wp_kses_post( get_the_archive_description() ); ?></div>
		<?php endif; ?>
	</div>
	...
	<div class="text-center py-20">
		<div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 mb-6">
			<svg class="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 7h.01M7 3h5a1.99 1.99 0 011.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
		</div>
		<h2 class="text-2xl font-bold text-gray-900 mb-2"><?php esc_html_e( 'Nothing Found', 'blog-pro' ); ?></h2>
		<p class="text-gray-600 mb-6"><?php esc_html_e( 'No posts are tagged with this term yet.', 'blog-pro' ); ?></p>
		<?php get_search_form(); ?>
	</div>
	<?php endif; ?>
</div>
