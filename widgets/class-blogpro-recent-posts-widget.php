...
/**
 * Widget: Recent Posts.
 * Thumbnail + title + date list, Tailwind-styled.
 */
if ( ! defined( 'ABSPATH' ) ) exit;

class BlogPro_Recent_Posts_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'blogpro_recent_posts',
			__( 'Blog Pro: Recent Posts', 'blog-pro' ),
			array( 'description' => __( 'Recent posts with thumbnail, title and date.', 'blog-pro' ) )
		);
	}

	public function widget( $args, $instance ) {
		$title  = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Recent Posts', 'blog-pro' );
